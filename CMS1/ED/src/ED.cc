...
//
// $Author: latb $
// $Date: 2007/06/14 19:40:07 $
// $Revision: 1.1.2.1 $
//

#include "CMS1/ED/interface/ED.h"
...
ED::ED(const edm::ParameterSet& iConfig)
{
...
void
	ED::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
	ED::beginJob(const edm::EventSetup& es)
{
...
void ED::displayCaloTowers(const edm::Event& iEvent) {
...
void ED::displayCaloTower(double eta, double phi, double et, int color, int black) {
