...
#include "GutSoftAnalyzers/TrackAnalyzer/interface/TrackAnalyzer.h"
...
TrackAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  try {
	...
	edm::LogWarning("TrackAnalyzer") << "Collection reco::TrackCollection with label " << trackProducerLabel_ << " cannot be found, using empty collection of same type";
      }
    }
  }
