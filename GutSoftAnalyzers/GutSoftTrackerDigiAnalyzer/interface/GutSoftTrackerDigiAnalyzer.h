#ifndef GutSoftTrackerDigiAnalyzer_h
#define GutSoftTrackerDigiAnalyzer_h
...
class GutSoftTrackerDigiAnalyzer : public edm::EDAnalyzer {
 public:
  explicit GutSoftTrackerDigiAnalyzer(const edm::ParameterSet&);
 ...
 private:
  ...
  edm::InputTag pixelDigiInputTag_;
  edm::InputTag stripDigiInputTag_;
