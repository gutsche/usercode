...
#include "GutSoftAnalyzers/TrackCandidateAnalyzer/interface/TrackCandidateAnalyzer.h"
...
TrackCandidateAnalyzer::TrackCandidateAnalyzer(const edm::ParameterSet& iConfig)
{
...
TrackCandidateAnalyzer::~TrackCandidateAnalyzer()
{
...
void
TrackCandidateAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  try {
	...
	edm::LogWarning("TrackCandidateAnalyzer") << "Collection TrackCandidateCollection with label " << trackCandidateProducerLabel_ << " cannot be found, using empty collection of same type";
      }
    }
  }
...
void 
TrackCandidateAnalyzer::beginJob(const edm::EventSetup&)
{
  // HistogramFactory
