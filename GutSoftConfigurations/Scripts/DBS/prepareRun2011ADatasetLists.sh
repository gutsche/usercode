...
cat datasets.list | grep '/RECO' | grep -i 16Sep2011 | grep v3 > 16Sep2011_reco_v3.list
cat datasets.list | grep '/AOD' | grep -i 16Sep2011 | grep v3 > 16Sep2011_aod_v3.list
cat datasets.list | grep '/DQM' | grep -i 16Sep2011 | grep v3 > 16Sep2011_dqm_v3.list
cat datasets.list | grep '/ALCARECO' | grep -i 16Sep2011 | grep v3 > 16Sep2011_alcareco_v3.list
cat datasets.list | grep '/RAW-RECO' | grep -i 16Sep2011 | grep v3 > 16Sep2011_skims_v3.list
cat datasets.list | grep '/USER' | grep -i 16Sep2011 | grep v3 >> 16Sep2011_skims_v3.list
# 16Sep2011_reco_v3.list 16Sep2011_aod_v3.list 16Sep2011_dqm_v3.list 16Sep2011_alcareco_v3.list 16Sep2011_skims_v3.list 16Sep2011_skims_v3.list

cat datasets.list | grep '/RECO' | grep -i 16Sep2011 | grep v4 > 16Sep2011_reco_v4.list
cat datasets.list | grep '/AOD' | grep -i 16Sep2011 | grep v4 > 16Sep2011_aod_v4.list
cat datasets.list | grep '/DQM' | grep -i 16Sep2011 | grep v4 > 16Sep2011_dqm_v4.list
cat datasets.list | grep '/ALCARECO' | grep -i 16Sep2011 | grep v4 > 16Sep2011_alcareco_v4.list
cat datasets.list | grep '/RAW-RECO' | grep -i 16Sep2011 | grep v4 > 16Sep2011_skims_v4.list
cat datasets.list | grep '/USER' | grep -i 16Sep2011 | grep v4 >> 16Sep2011_skims_v4.list
# 16Sep2011_reco_v4.list 16Sep2011_aod_v4.list 16Sep2011_dqm_v4.list 16Sep2011_alcareco_v4.list 16Sep2011_skims_v4.list 16Sep2011_skims_v4.list
...
cat datasets.list | grep '/RECO' | grep -i 08Nov2011 | grep v2 > 08Nov2011_reco_v2.list
cat datasets.list | grep '/AOD' | grep -i 08Nov2011 | grep v2 > 08Nov2011_aod_v2.list
cat datasets.list | grep '/DQM' | grep -i 08Nov2011 | grep v2 > 08Nov2011_dqm_v2.list
cat datasets.list | grep '/ALCARECO' | grep -i 08Nov2011 | grep v2 > 08Nov2011_alcareco_v2.list
cat datasets.list | grep '/RAW-RECO' | grep -i 08Nov2011 | grep v2 > 08Nov2011_skims_v2.list
cat datasets.list | grep '/USER' | grep -i 08Nov2011 | grep v2 >> 08Nov2011_skims_v2.list
# 08Nov2011_reco_v2.list 08Nov2011_aod_v2.list 08Nov2011_dqm_v2.list 08Nov2011_alcareco_v2.list 08Nov2011_skims_v2.list 08Nov2011_skims_v2.list
