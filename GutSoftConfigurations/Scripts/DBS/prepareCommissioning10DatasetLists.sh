...
diff datasets.list datasets_kit.list | grep '/ZeroBias/' | grep 'PromptReco' | grep 'v1' | grep '<' | awk '{print $2}'
diff datasets.list datasets_kit.list | grep '/ZeroBias/' | grep 'PromptReco' | grep 'v2' | grep '<' | awk '{print $2}'
diff datasets.list datasets_kit.list | grep '/ZeroBias/' | grep 'PromptReco' | grep 'v3' | grep '<' | awk '{print $2}'
diff datasets.list datasets_kit.list | grep '/ZeroBias/' | grep 'PromptReco' | grep 'v4' | grep '<' | awk '{print $2}'
...
diff datasets.list datasets_kit.list | grep '/MinimumBias/' | grep 'Apr1' | grep '<' | awk '{print $2}'