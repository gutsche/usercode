...
cat datasets.list | grep -vi express | grep -vi preproduction | grep Jun14thReReco > rereco_Jun14thReReco.list
...
cat datasets.list | grep -vi express | grep -vi preproduction | grep Jun14thSkim > rereco_Jun14thSkim.list
