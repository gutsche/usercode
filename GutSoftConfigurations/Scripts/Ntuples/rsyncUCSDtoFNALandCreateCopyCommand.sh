...
#rsync -n -a -i --ignore-existing uaf-5.t2.ucsd.edu:/data/tmp/fgolf/ . | grep merge | awk '{print $2}' | awk '{print "lcg-cp -v -n 20 file:////`pwd`/"$1" srm://cmssrm.fnal.gov:8443/srm/managerv2?SFN=/resilient/gutsche/"$1}'
